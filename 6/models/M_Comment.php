...
class M_Comment
{
    ...
    {
        $query = sprintf("SELECT * FROM comments WHERE id_article=%d ORDER BY id_comment DESC", $id_article);
    ...
    // Создать комментарий
    //
    public static function Create($id_article, $user, $text)
    {
        $object = ['user' => $user, 'text' => $text, 'id_article' => $id_article];
    ...
    //
    public static function Edit($id_comment, $text)
    {
        $object = ['text' => $text];
